...
%% API
-export([methods/0, init_cipher_info/2, encode/2, decode/2, key_iv_len/1, stream_init/3, hmac/2, rc4_test/0]).
...
init_cipher_info(Method, Password) ->
    ...
    NewIv = crypto:rand_bytes(IvLen),    %%得到一个随机的向量
...
%% aes_128_cfb | aes_192_cfb | aes_256_cfbaes_256_cfb
%% aes是块加密
...
rc4_test() ->
    Cipher = init_cipher_info(aes_192_cfb, "xx"),
    Data1 = <<"hello world">>,
    Data2 = <<"baby">>,
